...
static void send_message(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle, char *buffer)
{
    ...
    else
    {
        ...
        if (IoTHubClient_LL_SendEventAsync(iotHubClientHandle, messageHandle, send_callback, NULL) != IOTHUB_CLIENT_OK)
        {
...
IOTHUBMESSAGE_DISPOSITION_RESULT receive_message_callback(IOTHUB_MESSAGE_HANDLE message, void *userContextCallback)
{
